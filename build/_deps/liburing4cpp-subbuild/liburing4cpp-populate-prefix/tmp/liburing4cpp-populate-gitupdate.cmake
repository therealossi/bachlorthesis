...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "async"
  WORKING_DIRECTORY "/home/ossi/Github/poseidon_bufferpool/build/_deps/liburing4cpp-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("async" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/async")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"async\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ossi/Github/poseidon_bufferpool/build/_deps/liburing4cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ossi/Github/poseidon_bufferpool/build/_deps/liburing4cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
